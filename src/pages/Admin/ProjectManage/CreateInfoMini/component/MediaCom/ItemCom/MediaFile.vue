...
export default {
  ...
  methods: {
    ...
    check() {
      ...
      if (
        fileList.some((v) => v.file.name === this.$store.state.base.Assetbundle)
      ) {
      ...
      return this.check().then((res) => {
        ...
        if (res.code === 1000) {
          return this.$refs.uploadRef
            ...
            .then((res) => {
              console.log(this.indexFun(), res.successList[0], '123123')
