  ...
  <div class="mediaParam">
    <div class="mediaItem">
      ...
      <div class="mediaValue">
        <div class="valueItem" v-for="item in positionList" :key="item.key">
          <div class="valueLabel">{{ item.key }}:</div>
          <div class="sliderValue">
            <Slider v-model="item.value" @input="handleValueChange">
              <template slot="before">
                <img class="sliderIcon" :src="item.beforeIcon" alt="" />
              </template>
              <template slot="after">
                <img class="sliderIcon" :src="item.afterIcon" alt="" />
              </template>
            </Slider>
          </div>
        </div>
    ...
    <div class="mediaItem">
      ...
      <div class="mediaValue" style="margin-left: -4px">
        <div class="valueItem" v-for="item in scaleList" :key="item.key">
    ...
    <div class="mediaItem">
      ...
      <div class="mediaValue">
        <div class="valueItem" v-for="item in rotateList" :key="item.key">
          <div class="valueLabel">{{ item.key }}:</div>
          <div class="sliderValue">
            <Slider v-model="item.value" @input="handleValueChange">
              <template slot="before">
    ...
    return {
      positionList: [
        ...
        },
        {
          ...
          afterIcon: paramIcon.position_z_add
        }
      ],
      scaleList: [
        {
