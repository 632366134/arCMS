  ...
  <div class="container">
    ...
    <div class="breadcrumb">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>当前单页111</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="projectList">
      ...
      <div class="projectItem" v-for="item in list" :key="item.mediaCode">
        ...
        <div class="projectInfo">
          ...
          <div class="projectName">{{ item.mediaTitle }}</div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    @loading()
    fetchList() {
      return this.fetchClass().then((classCode) => {
        return searchAPI
          .selMediaList({
           userCode: sessionStorage.userCode,
            projectCode: this.projectCode,
    ...
    init() {
      const { projectCode, basePicCode, projectName } = this.$route.params
      this.projectCode = this.$decode(projectCode)
      this.basePicCode = this.$decode(basePicCode)
