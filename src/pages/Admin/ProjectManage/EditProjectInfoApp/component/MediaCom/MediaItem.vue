        ...
        <el-form label-width="120px" class="mediaInfoMain">
          ...
          <el-form-item label="资源文件上传:">
            <MediaFile
              ...
              ref="mediaFileRef"
              :mediaType="mediaType"
              :mediaCode="mediaDataList().mediaCode || data.mediaCode"
            />
          </el-form-item>
...
export default {
        ...
        return {
          ...
          mediaFun: async () => {
            ...
            for (let i = 0; i < list.length; i++) {
              ...
              delete item.isBenti
              if (isBenti) {
                data = this.mediaDataList().mediaCode || this.data.mediaCode
              }
  ...
  created() {
    console.log(this.mediaDataList, 'mediaDataListmediaDataList')
    this.mediaData = this.mediaDataList() || {}
    this.paramInfo = this.paramInfoList() || {}
    this.mediaType = this.mediaData.mediaType || ''
    this.$watch('mediaType', () => {
      this.reset()
    })
    console.log(this.mediaType, 'mediaTypemediaTypemediaType')
